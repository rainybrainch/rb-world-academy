          ...
          <div className="space-y-3">
            {courses.map(({ course, category }) => (
              <Link
                ...
                className="block rounded-lg p-4 border-2 transition-all hover:scale-102 active:scale-95"
                style={{
                  background: 'white',
              ...
              >
                ...
                {course.description && (
                  <p className="text-xs" style={{ color: 'rgba(26,26,46,0.55)', fontFamily: "'Zen Maru Gothic', sans-serif" }}>
                    {course.description}
                  </p>
                )}
